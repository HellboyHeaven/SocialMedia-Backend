...
public class CloudFrontCdnProvider(IConfiguration configuration, IAmazonS3 s3Client) : ICdnProvider
{
    ...
    public async Task<bool> DeleteFilesAsync(List<string> urls)
    {
    ...
    public async Task<List<string>> UploadFilesAsync(List<IFormFile> files, int maxDegreeOfParallelism = 5)
    {
